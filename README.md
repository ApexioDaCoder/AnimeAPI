...
### <div align="center">AnimeAPI is a anime streaming and discovery api built using NodeJS and express that scrapes Gogoanime and Animixplay to return data</div>Commi
...
```js
axios.get("/gogoanime/search?keyw=jujutsu").then((response) => response.data);
```
...
```js
axios.get("/animix/search?keyw=jujutsu").then((response) => response.data);
```
...
```js
axios.get("/recent-episodes").then((response) => response.data);
```
...
```js
axios.get("/popular").then((response) => response.data);
```
...
```js
axios.get("/gogoanime/info/one-piece").then((response) => response.data);
```
...
```js
axios.get("/animix/info/21").then((response) => response.data);
```
...
```js
axios.get("/episodes/one-piece").then((response) => response.data);
```
...
```js
axios
  .get("/gogoanime/watch/one-piece-episode-1015")
...
```js
axios
  .get("/animix/watch/one-piece-episode-1015")
  .then((response) => response.data);
```
